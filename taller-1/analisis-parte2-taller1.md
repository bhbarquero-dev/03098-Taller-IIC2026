...
| `anfitrion-propiedad-resenas.html` *(nueva)* | Anfitrión | 4,7 | Tabla de reseñas de una propiedad del anfitrión (línea 214: "el anfitrión podrá consultar las valoraciones y comentarios"): huésped, reseña, valoración, enlaces "Responder" y "Reportar" por fila. Accesible desde "Ver reseñas" en `anfitrion-propiedades.html`, solo en propiedades con valoración | Media |
| `anfitrion-resena-responder.html` *(nueva)* | Anfitrión | 4,6,7 | Detalle completo de la reseña (lectura) + formulario de respuesta | Media |
